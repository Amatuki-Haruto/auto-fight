...
1. ブラウザが開き、ホームページが表示されます
2. **ログインするまで待機**します（自動操作は一切しません）
3. ログイン後、自動でダンジョン探索のループが開始されます
4. セッションは `browser_data` フォルダに保存され、次回以降はログイン不要です
...
**「ラッキーチャンスを終了した」** ボタンを押すと、20秒後に探索から再開します。

### 4. レベル100

街に戻った後にレベル100を検知すると、Web通知を送り、自動操作を停止します。
